...
export const FEEDBACK_MODES: FeedbackMode[] = [
  {
    ...
    placeholder: "What's the idea? What problem does it solve? Who's the target customer and how do they pay?",
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe the plan, strategy, or system. Include your main assumptions and key dependencies.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe your situation or plan in detail. What do you know? What have you already considered?',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Paste your plan here. Include goals, steps, timeline, and what resources you have.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: "Describe what you want evaluated. Provide context — what's the goal and who's the audience?",
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe the idea, project, or plan. What are you trying to achieve and how?',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: "What's the situation? What have you tried? What story are you telling yourself about why it hasn't worked?",
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Share what you want feedback on. Be specific — vague input gets vague output.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: "What's the business? Describe the market, your solution, traction if any, and your ask.",
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Paste your bio, or describe your opening lines, what you say on dates, and what you think is working or not.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe the decision, the numbers involved, your current financial situation, and your reasoning.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Paste your content, copy, headline, email, or message in full.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe the move: current role, the opportunity, compensation, what you would give up, and your main hesitation.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe your current routine, goals, diet basics, sleep quality, and how long you have been at it.',
...
${JSON_FORMAT_INSTRUCTION}`,
  },
  {
    ...
    placeholder: 'Describe the negotiation: what you want, what they want, your alternatives, and any leverage you have.',
